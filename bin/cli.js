...
program
  ...
  .option('-t, --transform <transform>', 'Transform (jssToEmotion, makeStyles, withStyles)', 'jssToEmotion')
  ...
  .action(async (patterns, options) => {
    ...
    if (isDryRun) {
      ...
      printHeader('🎨', 'JSS to Emotion Migrator', 'Converting makeStyles/withStyles to styled()');
    }
